...
Revision ID: ed0c2b1190d2
Revises: 
Create Date: 2025-11-10 18:12:26.209709
...
def upgrade() -> None:
    ...
    op.create_index('ix_asset_name', 'assets', ['asset_project_id'], unique=False)
